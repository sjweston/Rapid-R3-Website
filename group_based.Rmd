...
```{r}
dist_cat(income.cat, data = filter(scored, group == 1))
```

## Poverty

```{r}
dist_cat(poverty_cat, data = filter(scored, group == 1))
```

## Race

```{r}
dist_cat(race_ethnic, data = filter(scored, group == 1))
```

## Ethnicity

```{r}
dist_cat(latinx_cat, data = filter(scored, group == 1))
```
