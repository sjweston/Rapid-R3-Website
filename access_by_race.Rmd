...
scored = scored %>%
  mutate(
    poc_lowincome = ifelse((white == 0 | latinx == 1) & poverty == 1, 1,0),
    poc_hghincome = ifelse((white == 0 | latinx == 1) & poverty == 0, 1,0),
    white_hghincome = ifelse((white == 1 & latinx == 0) & poverty == 0, 1,0),
    white_lowincome = ifelse((white == 1 & latinx == 0) & poverty == 1, 1,0),
    black_lowincome = ifelse(black == 1 & poverty == 1, 1, 0),
    black_hghincome = ifelse(black == 1 & poverty == 0, 1, 0),
    latinx_lowincome = ifelse(latinx == 1 & poverty == 1, 1, 0),
    latinx_hghincome = ifelse(latinx == 1 & poverty == 0, 1, 0)
  )

demo_groups = c("white_hghincome", "white_lowincome", 
                "poc_hghincome", "poc_lowincome",  
                "black_hghincome", "black_lowincome",
                "latinx_hghincome", "latinx_lowincome")
demo_labels = c("White, high income", "White, low income", 
