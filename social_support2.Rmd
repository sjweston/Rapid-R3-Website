...
### At least one hardship (White/BIPOC)
...
plot = scored %>%
  mutate_at(vars(mh_eviction, mh_foreclose), .funs = function(x) ifelse(x == 6, NA, x)) %>%
  mutate_at(vars(starts_with("mh_")), .funs = function(x) ifelse(x > 1, 1, 0)) %>%
  filter(!is.na(mh_food) & !is.na(latinx)) %>%
  mutate(mh_all = rowSums(select(., contains("mh_")), na.rm=T)) %>%
  filter(!is.na(mh_all)) %>%
  group_by(CaregiverID) %>%
  filter(row_number() == 1) %>%
...
plot = scored %>%
  mutate_at(vars(mh_eviction, mh_foreclose), .funs = function(x) ifelse(x == 6, NA, x)) %>%
  mutate_at(vars(starts_with("mh_")), .funs = function(x) ifelse(x > 1, 1, 0)) %>%
  filter(!is.na(mh_food) & !is.na(white)) %>%
  mutate(mh_all = rowSums(select(., contains("mh_")), na.rm=T)) %>%
    filter(!is.na(mh_all)) %>%
  group_by(CaregiverID) %>%
  filter(row_number() == 1) %>%
...
plot = scored %>%
  mutate_at(vars(mh_eviction, mh_foreclose), .funs = function(x) ifelse(x == 6, NA, x)) %>%
  mutate_at(vars(starts_with("mh_")), .funs = function(x) ifelse(x > 1, 1, 0)) %>%
  filter(!is.na(mh_food) & !is.na(single)) %>%
  mutate(mh_all = rowSums(select(., contains("mh_")), na.rm=T)) %>%
    filter(!is.na(mh_all)) %>%
  group_by(CaregiverID) %>%
  filter(row_number() == 1) %>%
...
plot = scored %>%
  mutate_at(vars(mh_eviction, mh_foreclose), .funs = function(x) ifelse(x == 6, NA, x)) %>%
  mutate_at(vars(starts_with("mh_")), .funs = function(x) ifelse(x > 1, 1, 0)) %>%
  filter(!is.na(mh_food) & !is.na(disability)) %>%
  mutate(mh_all = rowSums(select(., contains("mh_")), na.rm=T)) %>%
    filter(!is.na(mh_all)) %>%
  group_by(CaregiverID) %>%
  filter(row_number() == 1) %>%
