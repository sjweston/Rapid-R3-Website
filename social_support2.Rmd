...
plot_data %>%
  ggplot(aes(x = mh_all, y = percent, fill = latinx)) +
  geom_bar(stat = "identity", position = "dodge") +
  coord_flip()+
  labs(title = "Material hardship", y = "Percent", x = NULL) +
  theme_pubr()
 ...
 filter(!is.na(mh_all)) %>%
  ...
  mutate(percent = 100*count/sum(count),
   ...
   mutate(white = factor(white, 
                             ...
                             labels = c("Not White", 
                                        "White"))) %>%
  ggplot(aes(x = mh_all, y = percent, fill = white)) +
  geom_bar(stat = "identity", position = "dodge") +
  coord_flip()+
  labs(title = "Material hardship", y = "Percent", x = NULL) +
  theme_pubr()
...
plot_data %>%
  ggplot(aes(x = mh_all, y = percent, fill = single)) +
  geom_bar(stat = "identity", position = "dodge") +
  coord_flip()+
  labs(title = "Material hardship", y = "Percent", x = NULL) +
  theme_pubr()
...
plot = scored %>%
  ...
  ggplot(aes(x = mh_all, y = percent, fill = disability)) +
  geom_bar(stat = "identity", position = "dodge") +
  coord_flip()+
  labs(title = "Material hardship", y = "Percent", x = NULL) +
  theme_pubr()
