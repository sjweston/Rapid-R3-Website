...
```{r open-childcare-10, results='hide'}
...
```{r open-childcare-18, eval=FALSE, include=FALSE}
set.seed(07312020)
plan(multiprocess)
...
```{r open-childcare-68, results='hide'}
...
```{r open-childcare-76, eval=FALSE, include=FALSE}
set.seed(07312020)
plan(multiprocess)
