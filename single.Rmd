...
chisq.test(week1$single, week1$income_decreaed)
week1 %>%
  ungroup()%>%
...
```{r}
chisq.test(week1$single, week1$decrease_nonfamilyCC)
week1 %>%
  ungroup()%>%
...
```{r}
chisq.test(week1$single, week1$difficulty_basics)
week1 %>%
  ungroup()%>%
...
```{r}
chisq.test(week1$single, week1$delay_healthcare)
week1 %>%
  ungroup()%>%
