...
sp_week3$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_caregiver_spline3.csv"))
```
...
sp_week3$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_anxiety_spline3.csv"))
...
sp_week3$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_depress_spline3.csv"))
...
sp_week3$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_stress_spline3.csv"))
...
sp_week3$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_lonely_spline3.csv"))
...
sp_week7$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_caregiver_spline7.csv"))
...
sp_week7$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_anxiety_spline7.csv"))
```
...
sp_week7$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_depress_spline7.csv"))
```
...
sp_week7$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_stress_spline7.csv"))
```
...
sp_week7$pdata %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  select(Week, states_groups, fit) %>%
  write.csv(., file = here("figure data/07232020_lonely_spline7.csv"))
```

```{r}
sp_week7$plotdata %>%
  mutate(dot = round(m,2)) %>%
  filter(states_groups %in% c("NY/NJ", "TX/FL/AZ")) %>%
  ungroup() %>%
  select(Week, states_groups, dot) %>%
  write.csv(file = here("figure data/07-24-2020_lonely_dots.csv"))
```
...
sp_week7$pdata %>%
  ...
  ungroup() %>%
  select(Week, states_groups, fit) %>%
  write.csv(file = here("figure data/07-24-2020_caregiver-mental-health.csv"))
```
...
sp_week7$plotdata %>%
  ...
  ungroup() %>%
  select(Week, states_groups, dot) %>%
  write.csv(file = here("figure data/07-24-2020_caregiver-mental-health_dots.csv"))
```
...
sp_week7$pdata %>%
  ...
  ungroup() %>%
  select(Week, states_groups, fit) %>%
  write.csv(file = here("figure data/07-24-2020_caregiver-loneliness.csv"))
```
