...
```{r}
sp_week3 = state_splines.groups(scored, outcome = mental_health, group = states_groups, point = 3)
...
```{r}
sp_week3 = state_splines.groups(scored, outcome = anxiety, group = states_groups, point = 3)
...
```{r}
sp_week3 = state_splines.groups(scored, outcome = depress, group = states_groups, point = 3)
...
```{r}
sp_week3 = state_splines.groups(scored, outcome = stress, group = states_groups, point = 3)
...
```{r}
sp_week3 = state_splines.groups(scored, outcome = lonely, group = states_groups, point = 3)
...
```{r}
sp_week3 = state_splines.groups(scored, outcome = fussy, group = states_groups, point = 3)
...
```{r}
sp_week3 = state_splines.groups(scored, outcome = fear, group = states_groups, point = 3)
...
```{r}
sp_week7 = state_splines.groups(scored, outcome = mental_health, group = states_groups, point = 7)
...
```{r}
sp_week7 = state_splines.groups(scored, outcome = anxiety, group = states_groups, point = 7)
...
```{r}
sp_week7 = state_splines.groups(scored, outcome = depress, group = states_groups, point = 7)
...
```{r}
sp_week7 = state_splines.groups(scored, outcome = stress, group = states_groups, point = 7)
...
```{r}
sp_week7 = state_splines.groups(scored, outcome = lonely, group = states_groups, point = 7)
...
```{r}
sp_week7 = state_splines.groups(scored, outcome = fussy, group = states_groups, point = 7)
...
```{r}
sp_week7 = state_splines.groups(scored, outcome = fear, group = states_groups, point = 7)
...
spline.df = spline.df %>%
  mutate(mod = map2(data, spline, .f = function(x,y) state_splines.groups(data = x, 
