...
scored = scored %>%
  mutate(states_groups = case_when(
    ...
    state %in% c("NY", "NJ", "CT") ~ "NY/NJ/CT",
    state == "CA" ~ "CA",
    TRUE ~ NA_character_)) %>%
  mutate(states_groups = as.factor(states_groups),
         states_groups = relevel(states_groups, ref = "NY/NJ/CT")) %>%
   rowwise() %>%
...
sp_week3 = splines.moderation(scored, outcome = mental_health, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 3)
...
sp_week3 = splines.moderation(scored, outcome = anxiety, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 3)
...
sp_week3 = splines.moderation(scored, outcome = depress, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 3)
...
sp_week3 = splines.moderation(scored, outcome = stress, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 3)
...
sp_week3 = splines.moderation(scored, outcome = lonely, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 3)
...
sp_week3 = splines.moderation(scored, outcome = fussy, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 3)
...
sp_week3 = splines.moderation(scored, outcome = fear, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 3)
...
sp_week7 = splines.moderation(scored, outcome = mental_health, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 7)
...
sp_week7 = splines.moderation(scored, outcome = anxiety, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 7)
...
sp_week7 = splines.moderation(scored, outcome = depress, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 7)
...
sp_week7 = splines.moderation(scored, outcome = stress, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 7)
...
sp_week7 = splines.moderation(scored, outcome = lonely, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 7)
...
sp_week7 = splines.moderation(scored, outcome = fussy, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 7)
...
sp_week7 = splines.moderation(scored, outcome = fear, group = states_groups, m = mh_d, m.labels = c("High Income", "Low Income"), point = 7)
