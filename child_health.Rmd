...
```{r}
wellbaby.age(childinsurance_type, filter(scored, childinsurance_type != "Don't Know"))
```
...
```{r}
barrer.group(childinsurance_type, filter(scored, childinsurance_type != "Don't Know"))
```