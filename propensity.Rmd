...
* OR if they reported using at least five hours of unpaid care by a relative, friend or neighbor for any child age 5 or under and _none_ of the types of care listed below. 
...
_Note: these questions were asked in weeks 5, 6, 9-current._
...
ps.childcare = ps(childcare_group ~ black + latinx + poverty150 + age + single + state + language + 
                    num_children_raw + childinsurance_type, 
...
> Propensity score weighting is one of the techniques used in controlling for selection biases in nonexperimental studies. Propensity scores can be used as weights to account for selection assignment differences between treatment and comparison groups. One of the advantages of this approach is
