...
# 1. COVID Vaccine
  * Survey question: How likely are you to get the first generation COVID-19 vaccine, as soon as it's available? - very likely/somewhat likely/not very likely/not at all likely\
  * How likely are you to get your child the first generation COVID-19 vaccine, as soon as it's available?- very likely/somewhat likely/not very likely/not at all likely\
...
vaccine_parent <- vaccine %>%
   ...
   pivot_longer (cols = c("a.very_likely", "b.somewhat_likely", "c.not_very_likely", "d.not_at_all_likely"), names_to = "rsp", values_to = "prop")%>%
   mutate (count = prop * n, 
