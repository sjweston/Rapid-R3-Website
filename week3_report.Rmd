---
title: "Week 3 (April 21 - April 27) Summary"
output: 
  html_document:
    toc: TRUE
    toc_float: TRUE
...
```{r, out.width='100%'}
source(here("Scripts/compare nation/gender.R"))
```

## Nationality

```{r, out.width='100%'}
source(here("Scripts/compare nation/nationality.R")) 
```

## Nationality by region

```{r, out.width='100%'}
source(here("Scripts/compare nation/nationality_region.R")) 
```

## Ethnicity by region

```{r, out.width='100%'}
source(here("Scripts/compare nation/ethnicity.R")) 
```