...
labels4 = c("white", "poc")
labelsi = c("High Income", "Low Income")
...
```{r inequality-23 }
histogram_plot(scored, anxiety, poverty150, labelsi, weight)
```


```{r inequality-24, eval = !weighted}
anova(lm(anxiety ~ poverty150, data = scored))
```

```{r inequality-25, eval = weighted}
anova(lm(anxiety ~ poverty150, data = scored, weights = scored$weight))
```
...
```{r inequality-44 }
histogram_plot(scored, depress, poverty150, c("High Income", "Low Income"), weight)
```


```{r inequality-45, eval = !weighted}
anova(lm(depress ~ poverty150, data = scored))
```

```{r inequality-46, eval = weighted}
anova(lm(depress ~ poverty150, data = scored, weights = scored$weight))
```
...
```{r inequality-65 }
histogram_plot(scored, stress, poverty150, labelsi, weight)
```


```{r inequality-66, eval = !weighted}
anova(lm(stress ~ poverty150, data = scored))
```

```{r inequality-67, eval = weighted}
anova(lm(stress ~ poverty150, data = scored, weights = scored$weight))
```

### Geographic Region

```{r inequality-68 }
histogram_plot(scored, stress, region, labels5, weight)
```
...
```{r inequality-86 }
histogram_plot(scored, lonely, poverty150, labelsi, weight)
```


```{r inequality-87, eval = !weighted}
anova(lm(lonely ~ poverty150, data = scored))
```

```{r inequality-88, eval = weighted}
anova(lm(lonely ~ poverty150, data = scored, weights = scored$weight))
```

### Geographic Region

```{r inequality-89 }
histogram_plot(scored, lonely, region, labels5, weight)
```
...
```{r inequality-107 }
histogram_plot(scored, fussy, poverty150, labelsi, weight)
```


```{r inequality-108, eval = !weighted}
anova(lm(fussy ~ poverty150, data = scored))
```

```{r inequality-109, eval = weighted}
anova(lm(fussy ~ poverty150, data = scored, weights = scored$weight))
```
...
```{r inequality-128 }
histogram_plot(scored, fear, poverty150, labelsi, weight)

```


```{r inequality-129, eval = !weighted}
anova(lm(fear ~ poverty150, data = scored))
```

```{r inequality-130, eval = weighted}
anova(lm(fear ~ poverty150, data = scored, weights = scored$weight))
```
...
```{r inequality-149 }
histogram_plot(scored, income, region, labels5, weight)
```
...
```{r inequality-167 }
percent_by_group(scored, sick_leave, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$sick_leave, scored$poverty150)
```
...
```{r inequality-188 }
percent_by_group(scored, unemployed, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$unemployed, scored$poverty150)
```
...
```{r inequality-209 }
percent_by_group(scored, employment_decreased, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$employment_decreased, scored$poverty150)
```
...
```{r inequality-231 }
percent_by_group(unemployed, free_food, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(unemployed$free_food, unemployed$poverty150)
```

```{r inequality-233, eval = weighted}
weights::wtd.chi.sq(unemployed$free_food,
                unemployed$poverty150,
                weight = unemployed$weight)
```
...
```{r inequality-252 }
percent_by_group(unemployed, lost_free_lunch, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(unemployed$lost_free_lunch, unemployed$poverty150)
```
...
```{r inequality-273 }
percent_by_group(scored, plan_cc_samenow, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$plan_cc_samenow, scored$poverty150)
```
...
```{r inequality-294 }
percent_by_group(scored, plan_cc_differ, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$plan_cc_differ, scored$poverty150)
```
...
```{r inequality-315 }
percent_by_group(scored, plan_cc_sameCOVID, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$plan_cc_sameCOVID, scored$poverty150)
```
...
```{r inequality-336 }
percent_by_group(scored, plan_cc_dontknow, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$plan_cc_dontknow, scored$poverty150)
```
...
```{r inequality-379 }
percent_by_group(scored, expect_center, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$expect_center, scored$poverty150)
```
...
```{r inequality-401 }
percent_by_group(scored, expect_relative, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$expect_relative, scored$poverty150)
```
...
```{r inequality-423 }
percent_by_group(scored, expect_pro, poverty150, weight) %>%
  ggplot(aes(x = group, y = percent, fill = outcome)) +
  geom_bar(stat = "identity", position = "dodge") +
  geom_text(aes(label = round(percent), group = outcome, y = 5),
            position = position_dodge(.8),
...
chisq.test(scored$expect_pro, scored$poverty150)
```
