...
## 1.1 Percentage of Each Category
...
## 1.5 Ability to Afford Reducing Hours/Stopping Working 
...
## 1.6 Crosstab of Ability to Afford & Have Done
...
## 1.7 Crosstab of Being Forced to Reduce Hours/Leave Workforce & Have Reduced Hours/Left Workforce
...
wkf_reducing_hours <- wkf_rct_47 %>%
  filter (WKFORCE.001.a_0 == 0 & WKFORCE.001.a_1 == 1)%>%
  summarise (n = 694,
...
wkf_switching_less_demanding_job <- wkf_rct_47 %>%
  filter (WKFORCE.001.a_0 == 0 &  WKFORCE.001.a_2 == 1)%>%
  summarise (n = 694,
             forced_to_reduce_leave_work = sum (forced, na.rm = T)/n, 
             voluntarily_reduce_leave_work = sum (voluntarily, na.rm = T)/n)%>%
  pivot_longer (cols = c("forced_to_reduce_leave_work", "voluntarily_reduce_leave_work"), names_to = "condition", values_to = "prop")%>%
...
wkf_leave_absence <- wkf_rct_47 %>%
  filter (WKFORCE.001.a_0 == 0 & WKFORCE.001.a_3 == 1)%>%
  summarise (n = 694,
             forced_to_reduce_leave_work = sum (forced, na.rm = T)/n, 
             voluntarily_reduce_leave_work = sum (voluntarily, na.rm = T)/n)%>%
  pivot_longer (cols = c("forced_to_reduce_leave_work", "voluntarily_reduce_leave_work"), names_to = "condition", values_to = "prop")%>%
...
wkf_leaving_workforce <- wkf_rct_47 %>%
  filter (WKFORCE.001.a_0 == 0 &  WKFORCE.001.a_5 == 1)%>%
  summarise (n = 694,
             forced_to_reduce_leave_work = sum (forced, na.rm = T)/n, 
             voluntarily_reduce_leave_work = sum (voluntarily, na.rm = T)/n)%>%
  pivot_longer (cols = c("forced_to_reduce_leave_work", "voluntarily_reduce_leave_work"), names_to = "condition", values_to = "prop")%>%
...
wkf_move_to_parttime <- wkf_rct_47 %>%
  filter (WKFORCE.001.a_0 == 0 &  WKFORCE.001.a_4 == 1)%>%
  summarise (n = 694,
             forced_to_reduce_leave_work = sum (forced, na.rm = T)/n, 
             voluntarily_reduce_leave_work = sum (voluntarily, na.rm = T)/n)%>%
  pivot_longer (cols = c("forced_to_reduce_leave_work", "voluntarily_reduce_leave_work"), names_to = "condition", values_to = "prop")%>%
