...
```{r}
scored %>%
  select(binary_demos, anxiety, depress, stress, fear, fussy, days_sheltering, positive, hospitalizedCurrently, hospitalizedCumulative) %>%
  cor(., use = "pairwise") %>%
  corrplot::corrplot()
```
...
cor <-  scored %>%
  select(all_of(binary_demos), anxiety, depress, stress, fear, fussy, days_sheltering, positive, hospitalizedCurrently, hospitalizedCumulative) %>%
